...
plasma.update({"num_T": 7.9E+09, "num_B": 1.3E+09, "num_NK": 1.6E+09})
#plasma.update({"conc_A": 5 * units.ug/units.l / (170 * units.kDa), "conc_B": 0 * units.nM})
plasma.update({"conc_HER2": 980 * units.ng/units.l / (185 * units.kDa)})

lymph = {"name": "lymph"}
lymph.update({"volume": 274 * units.ml})
lymph.update({"num_T": 3.6E+11, "num_B": 1.6E+11, "num_NK": 6.7E+08})
#lymph.update({"conc_A": 0 * units.nM, "conc_B": 0 * units.nM})
lymph.update({"conc_HER2": 0 * units.nM})
...
lung.update({"num_cell": 2.36E+11 * 0.5, "num_T": 1.3E+10, "num_B": 6.8E+08, "num_NK": 7.2E+08})
...
liver.update({"num_cell": 3.90E+11 * 0.5, "num_T": 7.9E+09, "num_B": 1.8E+09, "num_NK": 5.5E+09})
#liver.update({"num_A": 10000, "num_B": 0})
liver.update({"num_HER2": 12005})
...
SI.update({"num_cell": 7.2e11 * 0.5, "num_T": 1.8E+10, "num_B": 6.1E+09, "num_NK": 8.1E+08})
#SI.update({"num_A": 1000, "num_B": 10000})
SI.update({"num_HER2": 58378})

skin = {"name": "skin"}
skin.update({"volume_plasma": 127 * units.ml, "volume_interstitial": 1125 * units.ml})
...
skin.update({"num_cell": 6.12E+11 * 0.5, "num_T": 2.7E+10, "num_B": 6.2E+08, "num_NK": 1.9E+09})
#skin.update({"num_A": 10000, "num_B": 0})
skin.update({"num_HER2": 15621})
...
kidney.update({"num_cell": 1.06E+11 * 0.5, "num_T": 496504047, "num_B": 7.1E+07, "num_NK": 1023295100}) # T anc NK numbers are calculated as density * volume
#kidney.update({"num_A": 10000, "num_B": 0})
kidney.update({"num_HER2": 35005})
...
gallbladder.update({"num_cell": 1.06E+11 * 0.5/4, "num_T": 496504047/4, "num_B": 7.1E+07/4, "num_NK": 1023295100/4}) # T anc NK numbers are calculated as density * volume
#gallbladder.update({"num_A": 10000, "num_B": 100000})
gallbladder.update({"num_HER2": 33165})
...
heart.update({"plasma_flow": 7752 * units.ml/units.h, "lymphatic_flow_ratio": 0.002})
heart.update({"num_cell": 5.64E+10 * 0.5, "num_T": 18211368, "num_B": 4.5E+07, "num_NK": 7249125}) # T anc NK numbers are calculated as density * volume
#heart.update({"num_A": 4441, "num_B": 6609})
heart.update({"num_HER2": 33165})
...
other.update({"num_cell": 1e13 * 0.5, "num_T": 1.1E+10, "num_B": 6.5E+08, "num_NK": 3.1E+09})
#other.update({"num_A": 10000, "num_B": 0})
other.update({"num_HER2": 10000})
