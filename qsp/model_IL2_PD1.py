...
Th = Cell("Th", ["P", "R"], [30000, 300], [0.05/units.h, 2.0/units.h],
          ...
          death = SIGNALS_ENV["tumor"] * 0.01 / units.d,
          prolif = SIGNALS_ENV["tumor"] * 0.5 / units.d * (0.05 - hill(30000 - SIGNALS_CEL["P"], 10000, EMAX = 0.1) + hill(SIGNALS_CEL["R"], 100, coef = 1, EMAX = 0.2)),
          diff = SIGNALS_ENV["tumor"] * 0.1 / units.d * hill(SIGNALS_CEL["R"], EC50 = 100, coef = 1.0, EMAX = 0.2),
          diff_cell = Treg)
...
Teff = Cell("Teff", ["P", "α"], [60000, 1500], [0.05/units.h, 2.0/units.h],
            ...
            death = SIGNALS_ENV["tumor"] * 0.01 / units.d,
            prolif = SIGNALS_ENV["tumor"] * 1.386 / units.d * (0.05 - hill(60000 - SIGNALS_CEL["P"], 10000, EMAX = 0.1) + hill(SIGNALS_CEL["α"], 100, coef = 3.1, EMAX = 0.2)),
            diff = SIGNALS_ENV["tumor"] * 0.5 / units.d * (hill(SIGNALS_ENV["Treg_per_Teff"], 1, EMAX = 0.05) + hill(60000 - SIGNALS_CEL["P"], 10000, EMAX = 0.1) + hill(SIGNALS_CEL["α"], 100, coef = 3.1, EMAX = 0.2)),
            diff_cell = Tex)
NK = Cell("NK", ["α"], [3000], [2.0/units.h],
          birth = SIGNALS_ENV["tumor"] * 0.01 / units.d * tumor_cell_total_density * 0.02,
          prolif = SIGNALS_ENV["tumor"] * 1.512 / units.d * hill(SIGNALS_CEL["α"], 100, coef = 1.3, EMAX = 0.3),
          death = SIGNALS_ENV["tumor"] * 0.01 / units.d)
