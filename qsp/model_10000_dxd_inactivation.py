...
permeability_surface_area_coefficient_BC = 0.105 * 0.25 * units.ml/units.h
permeability_surface_area_coefficients = {"heart": 1.47 * 0.25 * units.ml/units.h,
                                          "lung": 2.47 * 0.25 * units.ml/units.h,
                                          "muscle": 3.16 * 0.25 * units.ml/units.h,
                                          "skin": 0.681 * 0.25 * units.ml/units.h,
                                          "adipose": 0.588 * 0.25 * units.ml/units.h,
                                          "bone": 0.568 * 0.25 * units.ml/units.h,
                                          "brain": 0.00825 * 0.25 * units.ml/units.h,
                                          "kidney": 14.2 * 0.25 * units.ml/units.h,
                                          "liver": 49.2 * 0.25 * units.ml/units.h,
                                          "SI": 0.457 * 0.25 * units.ml/units.h,
                                          "LI": 0.457 * 0.25 * units.ml/units.h,
                                          "pancreas": 0.0657 * 0.25 * units.ml/units.h,
                                          "thymus": 0.457 * 0.25 * units.ml/units.h,
                                          "spleen": 0.457 * 0.25 * units.ml/units.h,
                                          "other": 0.457 * 0.25 * units.ml/units.h}
...
liver_clearance_rate = 137 * 0.33 * units.ml/units.h
...
K_on_HER2 = 0.03 * 0 / units.nM / units.h
