...
VIB4.update({"affn_C": 6.56e-8 * units.molar, "affn_A": 2e-8 * units.molar, "affn_B": 1.7e-9 * units.molar})
VIB4.update({"affm_C": 3.059e-6 * units.molar, "affm_A": 3.34e-7 * units.molar, "affm_B": 1.7e-9 * units.molar})
